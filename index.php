...
<style>
html,body,h1,h2,h3,h4,h5 {font-family: "Open Sans", sans-serif; border-radius = 0px;}
...
<div class="w3-top">
 <ul class="w3-navbar w3-theme-d2 w3-left-align w3-large">
  ...
  <li><a href="index.php" class="w3-padding-large w3-theme-d4"><i class="fa fa-home w3-margin-right"></i>PARLEY</a></li>
 ...
 if(isset($_SESSION['user_id']))
{
    ...
    if($questions_data->num_rows > 0)
    {
        ...
        {
            $question_id = $row['question_id']; // used later for $_GET
            $q_description =$row['q_description'];
            $current_user =$row['user_id'];

            // query to find topic
            $query_topic = "SELECT topic_name FROM topic WHERE topic_id IN ( SELECT topic_id FROM question WHERE question_id = '$question_id' )";
            ...
            $query = "SELECT * FROM answer WHERE question_id = '$question_id'";  // add a ranking parameter
            ...
            // insert username for answerer and upvote
...
// ?echo mysqli_num_rows($vote_data);
        ...
        <a href="viewanswer.php?question_id=<?php echo $question_id; ?>"><button type="button" class="w3-btn w3-theme-d2 w3-margin-bottom"><i class="fa fa-comment"></i> View All </button></a> 
      </div>
    ...
    <div class="w3-col m2">
      ...
      <div class="w3-card-2 w3-round w3-white w3-center">
        <div class="w3-container">
          <p>Friend Request</p>
          <img src="images/avatar2.png" alt="Avatar" style="width:50%"><br>
          <span>Jane Doe</span>
